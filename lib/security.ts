...
const FILE_EXTENSIONS = new Set([
  'js', 'mjs', 'cjs', 'jsx', 'ts', 'tsx', 'json', 'md', 'txt', 'csv', 'xml', 'yml', 'yaml',
  'html', 'htm', 'css', 'scss', 'sass', 'less', 'py', 'rb', 'go', 'rs', 'php', 'java', 'kt',
  'swift', 'c', 'cpp', 'cc', 'h', 'hpp', 'cs', 'sh', 'bash', 'zsh', 'bat', 'ps1', 'sql',
  'env', 'lock', 'log', 'ini', 'cfg', 'conf', 'toml', 'bak', 'tmp', 'zip', 'tar', 'gz', 'rar',
  'pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'png', 'jpg', 'jpeg', 'gif', 'svg',
  'webp', 'ico', 'mp3', 'mp4', 'mov', 'avi', 'exe', 'dll', 'dmg', 'iso', 'apk', 'jar',
]);

// نطاقات عليا أطول من ثلاثة أحرف نقبلها صراحةً (ما عداها نقبل 2-3 أحرف فقط).
const LONG_TLDS = new Set([
  'info', 'name', 'tech', 'store', 'online', 'cloud', 'email', 'agency', 'digital', 'systems',
  'network', 'company', 'today', 'world', 'group', 'live', 'blog', 'news', 'shop', 'site',
  'space', 'link', 'click', 'page', 'wiki', 'host', 'press', 'media', 'studio', 'design',
  'expert', 'center', 'solutions', 'academy', 'school', 'health', 'legal', 'finance',
]);
